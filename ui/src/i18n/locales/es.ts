...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.quantumclaw/quantumclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde quantumclaw dashboard --no-open en tu escritorio.",
    },
    insecure: {
