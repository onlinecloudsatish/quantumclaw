...
const UPDATE_BANNER_DISMISS_KEY = "quantumclaw:control-ui:update-banner-dismissed:v1";
              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="QuantumClaw" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${t("nav.control")}</span>
                          <span class="sidebar-brand__title">QuantumClaw</span>
                        </span>
                      `
                }
              </div>
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                <a
                  ...
                  href="https://docs.quantumclaw.ai"
