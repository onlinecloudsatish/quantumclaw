...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "quantumclaw-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as QuantumClawApp);
      void loadAssistantIdentity(host as unknown as QuantumClawApp);
      void loadAgents(host as unknown as QuantumClawApp);
      void loadHealthState(host as unknown as QuantumClawApp);
      void loadNodes(host as unknown as QuantumClawApp, { quiet: true });
      void loadDevices(host as unknown as QuantumClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as QuantumClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as QuantumClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as QuantumClawApp, payload);
