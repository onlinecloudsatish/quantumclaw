...
import { QuantumClawApp } from "./app.ts";
import {
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as QuantumClawApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as QuantumClawApp).resetToolStream();
  (state as unknown as QuantumClawApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as QuantumClawApp;
