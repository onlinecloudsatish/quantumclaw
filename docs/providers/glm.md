---
summary: "GLM model family overview + how to use it in QuantumClaw"
read_when:
  - You want GLM models in QuantumClaw
...
GLM is a **model family** (not a company) available through the Z.AI platform. In QuantumClaw, GLM
