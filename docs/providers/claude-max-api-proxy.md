...
You can point QuantumClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or QuantumClaw
...
- [Anthropic provider](/providers/anthropic) - Native QuantumClaw integration with Claude setup-token or API keys
