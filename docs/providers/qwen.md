---
summary: "Use Qwen OAuth (free tier) in QuantumClaw"
read_when:
  - You want to use Qwen with QuantumClaw
...
If you already logged in with the Qwen Code CLI, QuantumClaw will sync credentials
