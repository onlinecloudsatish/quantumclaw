---
summary: "Use Xiaomi MiMo models with QuantumClaw"
read_when:
  - You want Xiaomi MiMo models in QuantumClaw
...
Xiaomi MiMo is the API platform for **MiMo** models. QuantumClaw uses the Xiaomi
