---
summary: "Use Synthetic's Anthropic-compatible API in QuantumClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. QuantumClaw registers it as the
...
Note: QuantumClaw's Anthropic client appends `/v1` to the base URL, so use
