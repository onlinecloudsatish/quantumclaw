...
read_when:
  - You want to use Vercel AI Gateway with QuantumClaw
...
- QuantumClaw auto-discovers the Gateway `/v1/models` catalog, so `/models vercel-ai-gateway`
...
QuantumClaw accepts Vercel Claude shorthand model refs and normalizes them at
runtime:
