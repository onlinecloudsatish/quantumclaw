---
summary: "Use Qianfan's unified API to access many models in QuantumClaw"
read_when:
...
3. QuantumClaw installed on your system
...
4. Copy the API key for use with QuantumClaw

## CLI setup

```bash
quantumclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [QuantumClaw Configuration](/gateway/configuration)
