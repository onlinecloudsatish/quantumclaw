...
- Artifacts are stored under the temp subfolder: `$TMPDIR/quantumclaw-diffs`.
...
1. `browser.executablePath` in QuantumClaw config.
2. Environment variables:
   - `QUANTUMCLAW_BROWSER_EXECUTABLE_PATH`
