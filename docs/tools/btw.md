...
It is modeled after Claude Code's `/btw` behavior, but adapted to QuantumClaw's
...
If the main run is currently active, QuantumClaw snapshots the current message
