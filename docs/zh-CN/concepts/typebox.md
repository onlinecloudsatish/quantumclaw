...
- 生成的 Swift 模型：`apps/macos/Sources/QuantumClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/quantumclaw/quantumclaw/main/dist/protocol.schema.json
