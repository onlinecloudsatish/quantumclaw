---
summary: "First-run setup flow for QuantumClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give QuantumClaw">
...
<Step title="CLI">
  ...
  The app can install the global `quantumclaw` CLI via npm/pnpm so terminal
