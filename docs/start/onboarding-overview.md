---
summary: "Overview of QuantumClaw onboarding options and flows"
read_when:
...
QuantumClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `quantumclaw onboard`                     | Launch the app            |
...
CLI command docs: [`quantumclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the QuantumClaw app. The first-run wizard walks you through the same steps
