---
summary: "Deploy QuantumClaw on Render with Infrastructure-as-Code"
read_when:
  - Deploying QuantumClaw to Render
  - You want a declarative cloud deploy with Render Blueprints
title: "Render"
---

Deploy QuantumClaw on Render using Infrastructure as Code. The included `render.yaml` Blueprint defines your entire stack declaratively, service, disk, environment variables, so you can deploy with a single click and version your infrastructure alongside your code.
...
[Deploy to Render](https://render.com/deploy?repo=https://github.com/quantumclaw/quantumclaw)
...
repository configures everything needed to run QuantumClaw:
...
services:
  - type: web
    ...
    envVars:
      ...
      - key: QUANTUMCLAW_STATE_DIR
        value: /data/.quantumclaw
      - key: QUANTUMCLAW_WORKSPACE_DIR
        value: /data/workspace
      - key: QUANTUMCLAW_GATEWAY_TOKEN
        generateValue: true # auto-generates a secure token
    disk:
      name: quantumclaw-data
      mountPath: /data
      sizeGB: 1
```
...
The web dashboard is available at `https://<your-service>.onrender.com/quantumclaw`.
...
If you use the original QuantumClaw repository, Render will not auto-deploy your QuantumClaw. To update it, run a manual Blueprint sync from the dashboard.
...
For QuantumClaw, vertical scaling is usually sufficient. Horizontal scaling requires sticky sessions or external state management.
...
This downloads a portable backup you can restore on any QuantumClaw host.
