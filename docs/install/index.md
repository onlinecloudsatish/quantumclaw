---
summary: "Install QuantumClaw — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs QuantumClaw, and launches onboarding.
...
Or skip the link and use `pnpm quantumclaw ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
quantumclaw --version      # confirm the CLI is available
quantumclaw doctor         # check for config issues
quantumclaw gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy QuantumClaw on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove QuantumClaw completely.
  </Card>
</CardGroup>

## Troubleshooting: `quantumclaw` not found

If the install succeeded but `quantumclaw` is not found in your terminal:
