---
summary: "Host QuantumClaw on a DigitalOcean Droplet"
read_when:
  - Setting up QuantumClaw on DigitalOcean
  - Looking for a simple paid VPS for QuantumClaw
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent QuantumClaw Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `quantumclaw doctor --non-interactive` and check logs with `journalctl --user -u quantumclaw-gateway.service -n 50`.
