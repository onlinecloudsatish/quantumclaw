...
read_when:
  - You want QuantumClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables QuantumClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- Onboarding (`quantumclaw onboard`) and `quantumclaw channels add` list optional channel plugins.
