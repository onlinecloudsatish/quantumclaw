import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "quantumclaw/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "quantumclaw/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "quantumclaw/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/quantumclaw"),
    },
    modelAuth: {
