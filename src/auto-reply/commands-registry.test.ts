...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@quantumclaw", { botUsername: "quantumclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@quantumclaw args", {
        botUsername: "quantumclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@quantumclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "quantumclaw" })).toBe(
      "/help@otherbot",
    );
  });
