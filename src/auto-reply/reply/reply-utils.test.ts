...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bquantumclaw\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "QuantumClaw" },
        expected: "[QuantumClaw]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "QuantumClaw",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[QuantumClaw] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
