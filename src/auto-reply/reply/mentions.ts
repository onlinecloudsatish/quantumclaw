...
function resolveMentionPatterns(cfg: QuantumClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: QuantumClawConfig | undefined, agentId?: string): RegExp[] {
