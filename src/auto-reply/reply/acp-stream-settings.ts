...
function resolveAcpStreamCoalesceIdleMs(cfg: QuantumClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: QuantumClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: QuantumClawConfig): AcpProjectionSettings {
