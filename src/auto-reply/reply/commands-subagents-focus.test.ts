...
function createMatrixThreadCommandParams(commandBody: string, cfg: QuantumClawConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: QuantumClawConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
