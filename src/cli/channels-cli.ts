    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["quantumclaw channels list", "List configured channels and auth profiles."],
          ["quantumclaw channels status --probe", "Run channel status checks and probes."],
          [
            "quantumclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["quantumclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.quantumclaw.ai/cli/channels",
        )}\n`,
    );
