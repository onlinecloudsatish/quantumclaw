      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["quantumclaw gateway run", "Run the gateway in the foreground."],
            ["quantumclaw gateway status", "Show service status and probe reachability."],
            ["quantumclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["quantumclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.quantumclaw.ai/cli/gateway")}\n`,
      ),
  );
