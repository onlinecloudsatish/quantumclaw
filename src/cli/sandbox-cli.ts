...
const SANDBOX_EXAMPLES = {
  main: [
    ["quantumclaw sandbox list", "List all sandbox containers."],
    ["quantumclaw sandbox list --browser", "List only browser containers."],
    ["quantumclaw sandbox recreate --all", "Recreate all containers."],
    ["quantumclaw sandbox recreate --session main", "Recreate a specific session."],
    ["quantumclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["quantumclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["quantumclaw sandbox list", "List all sandbox containers."],
    ["quantumclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["quantumclaw sandbox recreate --all", "Recreate all containers."],
    ["quantumclaw sandbox recreate --session main", "Recreate a specific session."],
    ["quantumclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["quantumclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["quantumclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["quantumclaw sandbox explain", "Show effective sandbox config."],
    ["quantumclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["quantumclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["quantumclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.quantumclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
