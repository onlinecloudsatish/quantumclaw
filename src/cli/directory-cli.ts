    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["quantumclaw directory self --channel slack", "Show the connected account identity."],
          [
            'quantumclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["quantumclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "quantumclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.quantumclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
