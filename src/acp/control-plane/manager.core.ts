...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: QuantumClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: QuantumClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: QuantumClawConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: QuantumClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: QuantumClawConfig }): Promise<void> {
