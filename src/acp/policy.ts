...
export function isAcpEnabledByPolicy(cfg: QuantumClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: QuantumClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: QuantumClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: QuantumClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: QuantumClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: QuantumClawConfig, agentId: string): boolean {
