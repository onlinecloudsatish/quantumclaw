...
function makeCfg(overrides?: Partial<QuantumClawConfig>): QuantumClawConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): QuantumClawConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: QuantumClawConfig) {
