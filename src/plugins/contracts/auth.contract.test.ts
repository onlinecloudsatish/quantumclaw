...
import type { QuantumClawPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("quantumclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("quantumclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("quantumclaw/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("quantumclaw/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("quantumclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("quantumclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
function registerProviders(...plugins: Array<{ register(api: QuantumClawPluginApi): void }>) {
