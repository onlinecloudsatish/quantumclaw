...
export function applyProviderDefaultModel(cfg: QuantumClawConfig, modelRef: string): QuantumClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: QuantumClawConfig; modelId: string; modelRef: string; profileId: string } {
