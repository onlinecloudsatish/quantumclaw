...
import type { QuantumClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = QuantumClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("quantumclaw.pluginCommandsState");
