...
import type {
  ...
  QuantumClawPluginChannelRegistration,
  QuantumClawPluginCliRegistrar,
  QuantumClawPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  QuantumClawPluginHttpRouteAuth,
  QuantumClawPluginHttpRouteMatch,
  QuantumClawPluginHttpRouteHandler,
  QuantumClawPluginHttpRouteParams,
  QuantumClawPluginHookOptions,
  MediaUnderstandingProviderPlugin,
  ProviderPlugin,
  QuantumClawPluginService,
  QuantumClawPluginToolContext,
  QuantumClawPluginToolFactory,
  PluginConfigUiHint,
  PluginDiagnostic,
  PluginBundleFormat,
  PluginFormat,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: QuantumClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: QuantumClawPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  pluginName?: string;
  service: QuantumClawPluginService;
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: QuantumClawPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: QuantumClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: QuantumClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: QuantumClawPluginHookOptions | undefined,
    config: QuantumClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: QuantumClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: QuantumClawPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as QuantumClawPluginChannelRegistration).plugin === "object"
        ? (registration as QuantumClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: QuantumClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: QuantumClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: QuantumClawPluginCommandDefinition) => {
