...
function listPluginInvocationKeys(command: QuantumClawPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: QuantumClawPluginCommandDefinition): string[] {
