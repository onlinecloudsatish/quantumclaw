...
export const PLUGIN_MANIFEST_FILENAME = "quantumclaw.plugin.json";
...
// package.json "quantumclaw" metadata (used for setup/catalog)
...
export type QuantumClawPackageStartup = {
  /**
...
export type QuantumClawPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: QuantumClawPackageStartup;
};
...
): QuantumClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
