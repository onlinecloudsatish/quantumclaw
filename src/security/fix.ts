...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof QuantumClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: QuantumClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: QuantumClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
