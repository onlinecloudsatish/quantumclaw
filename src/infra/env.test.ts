...
describe("logAcceptedEnvOption", () => {
  it("logs accepted env options once with redaction and formatting", () => {
    ...
    withEnv(
      {
        ...
        QUANTUMCLAW_TEST_ENV: "  line one\nline two  ",
      },
      () => {
        logAcceptedEnvOption({
          key: "QUANTUMCLAW_TEST_ENV",
    ...
    expect(loggerMocks.info).toHaveBeenCalledWith(
      "env: QUANTUMCLAW_TEST_ENV=<redacted> (test option)",
    );
  });
    ...
    withEnv(
      {
        VITEST: "1",
        NODE_ENV: "development",
        QUANTUMCLAW_BLANK_ENV: "value",
      },
      () => {
        logAcceptedEnvOption({
          key: "QUANTUMCLAW_BLANK_ENV",
