...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when QUANTUMCLAW_VERSION is not set", async () => {
  ...
  it("prefers QUANTUMCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over QUANTUMCLAW_SERVICE_VERSION when QUANTUMCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        QUANTUMCLAW_VERSION: " ",
        QUANTUMCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when QUANTUMCLAW_VERSION and QUANTUMCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        QUANTUMCLAW_VERSION: " ",
        QUANTUMCLAW_SERVICE_VERSION: "\t",
