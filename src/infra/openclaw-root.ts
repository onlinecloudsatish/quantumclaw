...
const CORE_PACKAGE_NAMES = new Set(["quantumclaw"]);
...
export async function resolveQuantumClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveQuantumClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
