...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: QuantumClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: QuantumClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: QuantumClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: QuantumClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: QuantumClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: QuantumClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: QuantumClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: QuantumClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: QuantumClawConfig) => QuantumClawConfig;
