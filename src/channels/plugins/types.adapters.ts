...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: QuantumClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: QuantumClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: QuantumClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: QuantumClawConfig;
    accountId: string;
    enabled: boolean;
  }) => QuantumClawConfig;
  deleteAccount?: (params: { cfg: QuantumClawConfig; accountId: string }) => QuantumClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: QuantumClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: QuantumClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: QuantumClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: QuantumClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: QuantumClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.quantumclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: QuantumClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: QuantumClawConfig;
    nextCfg: QuantumClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: QuantumClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: QuantumClawConfig; accountId?: string | null }) =>
    | {
