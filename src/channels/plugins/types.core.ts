...
export type ChannelAgentToolFactory = (params: { cfg?: QuantumClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: QuantumClawConfig; accountId?: string | null }) => string[];
};
