...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: QuantumClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: QuantumClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: QuantumClawConfig): string {
