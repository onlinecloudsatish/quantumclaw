...
export function listChannelMessageActions(cfg: QuantumClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: QuantumClawConfig): ChannelMessageCapability[] {
