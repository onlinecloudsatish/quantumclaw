...
vi.mock("quantumclaw/plugin-sdk/channel-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("quantumclaw/plugin-sdk/channel-runtime")>();
  return {
    ...actual,
