...
describe("gateway auth", () => {
  ...
  it("resolves token/password from QUANTUMCLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          QUANTUMCLAW_GATEWAY_TOKEN: "env-token",
          QUANTUMCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides QUANTUMCLAW_GATEWAY_PASSWORD", () => {
