...
export function hasAmbiguousGatewayAuthModeConfig(cfg: QuantumClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: QuantumClawConfig): void {
