...
export function collectConfiguredModelPricingRefs(config: QuantumClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: QuantumClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
