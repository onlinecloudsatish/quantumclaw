  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set QUANTUMCLAW_GATEWAY_TOKEN/QUANTUMCLAW_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.QUANTUMCLAW_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
