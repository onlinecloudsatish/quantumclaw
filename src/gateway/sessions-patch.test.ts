...
const EMPTY_CFG = {} as QuantumClawConfig;
...
async function applySubagentModelPatch(cfg: QuantumClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): QuantumClawConfig {
  return {
    agents: {
      defaults: {
