...
const MCPORTER_STATE_KEY = Symbol.for("quantumclaw.mcporterState");
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: QuantumClawConfig }) {
