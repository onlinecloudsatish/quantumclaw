...
import type {
  ...
  QuantumClawPluginApi as CoreQuantumClawPluginApi,
...
import type { QuantumClawPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  QuantumClawPluginApi as SharedQuantumClawPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreQuantumClawPluginApi>().toMatchTypeOf<QuantumClawPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreQuantumClawPluginApi>().toMatchTypeOf<SharedQuantumClawPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("quantumclaw/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("quantumclaw/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("quantumclaw/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("quantumclaw/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("quantumclaw/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`quantumclaw/plugin-sdk/${id}`),
      ),
    ]);
