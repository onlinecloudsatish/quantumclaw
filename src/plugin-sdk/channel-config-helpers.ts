...
export function createScopedAccountConfigAccessors<
  ResolvedAccount,
  Config extends QuantumClawConfig = QuantumClawConfig,
>(params: {
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: QuantumClawConfig; accountId?: string | null }) =>
      mapAllowFromEntries(
...
function setTopLevelChannelEnabledInConfigSection<Config extends QuantumClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends QuantumClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends QuantumClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
