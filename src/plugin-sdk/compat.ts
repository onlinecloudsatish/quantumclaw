...
const shouldWarnCompatImport =
  ...
  process.env.QUANTUMCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "quantumclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused quantumclaw/plugin-sdk/<subpath> imports. See https://docs.quantumclaw.ai/plugins/sdk-migration",
    {
      code: "QUANTUMCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.quantumclaw.ai/plugins/sdk-migration",
    },
  );
}
