...
export type QuantumClawHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "quantumclaw-bundled" | "quantumclaw-managed" | "quantumclaw-workspace" | "quantumclaw-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: QuantumClawHookMetadata;
