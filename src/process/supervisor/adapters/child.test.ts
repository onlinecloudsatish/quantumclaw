...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.QUANTUMCLAW_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.QUANTUMCLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.QUANTUMCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
  ...
  it("disables detached mode in service-managed runtime", async () => {
    process.env.QUANTUMCLAW_SERVICE_MARKER = "quantumclaw";
