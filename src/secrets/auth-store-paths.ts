...
export function listAuthProfileStorePaths(config: QuantumClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: QuantumClawConfig, stateDir: string): string[] {
