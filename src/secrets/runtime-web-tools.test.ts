...
async function runRuntimeWebTools(params: { config: QuantumClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: QuantumClawConfig, provider: ProviderUnderTest): unknown {
