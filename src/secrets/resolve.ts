...
function resolveResolutionLimits(config: QuantumClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: QuantumClawConfig): SecretProviderConfig {
