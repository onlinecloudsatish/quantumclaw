...
import type { QuantumClawConfig } from "../config/types.quantumclaw.js";
...
export function resolveSessionDisplayDefaults(cfg: QuantumClawConfig): SessionDisplayDefaults {
