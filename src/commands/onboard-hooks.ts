...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.quantumclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("quantumclaw hooks list")}`,
      `  ${formatCliCommand("quantumclaw hooks enable <name>")}`,
      `  ${formatCliCommand("quantumclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
