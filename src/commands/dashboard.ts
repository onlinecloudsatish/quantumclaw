...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set QUANTUMCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `quantumclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control QuantumClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
