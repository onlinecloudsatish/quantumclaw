...
export function summarizeExistingConfig(config: QuantumClawConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.quantumclaw.ai/gateway/remote",
    "https://docs.quantumclaw.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
