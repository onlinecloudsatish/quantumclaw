...
function resolveDefaultAccountId(cfg: QuantumClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: QuantumClawConfig): boolean {
...
export function summarizeBindings(cfg: QuantumClawConfig, bindings: AgentBinding[]): string[] {
