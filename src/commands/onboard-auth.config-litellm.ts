...
export function applyLitellmProviderConfig(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyLitellmConfig(cfg: QuantumClawConfig): QuantumClawConfig {
