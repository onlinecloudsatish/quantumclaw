...
export function scanDiscordNumericIdEntries(cfg: QuantumClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(cfg: QuantumClawConfig): {
