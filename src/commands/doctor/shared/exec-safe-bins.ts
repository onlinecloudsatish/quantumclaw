...
function collectExecSafeBinScopes(cfg: QuantumClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: QuantumClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: QuantumClawConfig): {
