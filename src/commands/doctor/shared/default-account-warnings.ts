...
export function collectMissingDefaultAccountBindingWarnings(cfg: QuantumClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: QuantumClawConfig): string[] {
  const warnings: string[] = [];
