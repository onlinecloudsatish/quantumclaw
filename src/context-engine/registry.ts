...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("quantumclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("quantumclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: QuantumClawConfig): Promise<ContextEngine> {
