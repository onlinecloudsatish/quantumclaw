...
function resolveAnthropicDefaultAuthMode(cfg: QuantumClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyTalkApiKey(config: QuantumClawConfig): QuantumClawConfig {
...
export function applyTalkConfigNormalization(config: QuantumClawConfig): QuantumClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyLoggingDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyContextPruningDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyCompactionDefaults(cfg: QuantumClawConfig): QuantumClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
