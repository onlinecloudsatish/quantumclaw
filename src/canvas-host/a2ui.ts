...
export const A2UI_PATH = "/__quantumclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__quantumclaw__/canvas";

export const CANVAS_WS_PATH = "/__quantumclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.quantumclawCanvasA2UIAction.postMessage(...)
  // - Android: window.quantumclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["quantumclawCanvasA2UIAction"];
  ...
  globalThis.QuantumClaw = globalThis.QuantumClaw ?? {};
  globalThis.QuantumClaw.postMessage = postToNode;
  globalThis.QuantumClaw.sendUserAction = sendUserAction;
  globalThis.quantumclawPostMessage = postToNode;
  globalThis.quantumclawSendUserAction = sendUserAction;
