...
export function isCliProvider(provider: string, cfg?: QuantumClawConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: QuantumClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: QuantumClawConfig }): ModelCatalogEntry[] {
