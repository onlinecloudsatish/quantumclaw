...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/quantumclaw-sandbox",
    agentWorkspaceDir: "/tmp/quantumclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "quantumclaw-sbx-test",
    runtimeLabel: "quantumclaw-sbx-test",
    containerName: "quantumclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "quantumclaw-sbx-browser-test",
    },
