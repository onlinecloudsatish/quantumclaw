...
const CLEANUP_STATE_KEY = Symbol.for("quantumclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("quantumclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("quantumclaw.sessionWriteLockWatchdogState");
