...
export function resolveSubagentToolPolicy(cfg?: QuantumClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: QuantumClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: QuantumClawConfig["tools"];
