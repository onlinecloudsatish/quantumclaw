...
type ModelsConfig = NonNullable<QuantumClawConfig["models"]>;
...
function resolveExplicitBaseUrlProviders(
  providers: QuantumClawConfig["models"] | undefined,
): ReadonlySet<string> {
  return new Set(
...
export async function planQuantumClawModelsJson(params: {
  cfg: QuantumClawConfig;
