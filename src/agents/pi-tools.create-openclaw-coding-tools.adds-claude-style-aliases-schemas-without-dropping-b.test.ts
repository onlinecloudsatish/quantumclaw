...
const defaultTools = createQuantumClawCodingTools({ senderIsOwner: true });
...
describe("createQuantumClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: QuantumClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createQuantumClawCodingTools({
    ...
    const anthropicTools = createQuantumClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: QuantumClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createQuantumClawCodingTools({
    ...
    const denied = createQuantumClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createQuantumClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
