...
type QuantumClawReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: QuantumClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createQuantumClawReadTool(base, {
...
export function createQuantumClawReadTool(
  base: AnyAgentTool,
  options?: QuantumClawReadToolOptions,
): AnyAgentTool {
