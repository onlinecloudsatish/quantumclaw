...
export const DEFAULT_SANDBOX_IMAGE = "quantumclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "quantumclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "quantumclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "quantumclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "quantumclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "quantumclaw-sandbox-browser";
