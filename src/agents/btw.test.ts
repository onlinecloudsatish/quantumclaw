...
const ensureQuantumClawModelsJsonMock = vi.fn();
...
vi.mock("./models-config.js", () => ({
  ensureQuantumClawModelsJson: (...args: unknown[]) => ensureQuantumClawModelsJsonMock(...args),
}));
...
describe("runBtwSideQuestion", () => {
  beforeEach(() => {
    ...
    ensureQuantumClawModelsJsonMock.mockReset();
