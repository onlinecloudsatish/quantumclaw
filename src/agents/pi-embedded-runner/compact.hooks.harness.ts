...
export const createQuantumClawCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createQuantumClawCodingToolsMock.mockReset();
  createQuantumClawCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureQuantumClawModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveQuantumClawDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createQuantumClawCodingTools: createQuantumClawCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveQuantumClawAgentDir: vi.fn(() => "/tmp"),
  }));
