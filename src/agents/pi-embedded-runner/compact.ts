...
function resolvePostCompactionIndexSyncMode(config?: QuantumClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureQuantumClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createQuantumClawCodingTools({
      exec: {
