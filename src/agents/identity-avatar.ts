...
function resolveAvatarSource(cfg: QuantumClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: QuantumClawConfig, agentId: string): AgentAvatarResolution {
