...
export type SearchConfigRecord = (NonNullable<QuantumClawConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("quantumclaw.web-search.cache");
