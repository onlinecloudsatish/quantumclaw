...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    quantumclaw: process.env.QUANTUMCLAW_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.quantumclaw === undefined) {
      delete process.env.QUANTUMCLAW_GATEWAY_TOKEN;
    } else {
      process.env.QUANTUMCLAW_GATEWAY_TOKEN = envSnapshot.quantumclaw;
    }
  ...
  it("uses QUANTUMCLAW_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.QUANTUMCLAW_GATEWAY_TOKEN = "local-env-token";
