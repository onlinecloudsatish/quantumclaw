...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "quantumclaw-sbx-test",
    runtimeLabel: params.containerName ?? "quantumclaw-sbx-test",
    containerName: params.containerName ?? "quantumclaw-sbx-test",
