...
const QUANTUMCLAW_ATTRIBUTION_PRODUCT = "QuantumClaw";
const QUANTUMCLAW_ATTRIBUTION_ORIGINATOR = "quantumclaw";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: QUANTUMCLAW_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: QUANTUMCLAW_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${QUANTUMCLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
