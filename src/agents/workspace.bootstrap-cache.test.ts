...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("quantumclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("quantumclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("quantumclaw-cache-test2-");
