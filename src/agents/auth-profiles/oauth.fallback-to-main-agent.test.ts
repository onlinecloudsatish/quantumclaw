...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveQuantumClawAgentDir() returns mainAgentDir
    process.env.QUANTUMCLAW_STATE_DIR = tmpDir;
    process.env.QUANTUMCLAW_AGENT_DIR = mainAgentDir;
