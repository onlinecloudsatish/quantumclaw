...
function resolveAnthropicOpusThinking(cfg: QuantumClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<QuantumClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<QuantumClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<QuantumClawConfig> = {
        agents: {
          defaults: {
            models: {
