...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("quantumclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "quantumclaw");
