...
export function listBindings(cfg: QuantumClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: QuantumClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: QuantumClawConfig) {
