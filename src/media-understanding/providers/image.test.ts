...
const hoisted = vi.hoisted(() => ({
  ...
  ensureQuantumClawModelsJsonMock: vi.fn(async () => {}),
...
const {
  ...
  ensureQuantumClawModelsJsonMock,
...
vi.mock("../../agents/models-config.js", () => ({
  ensureQuantumClawModelsJson: ensureQuantumClawModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    const result = await describeImageWithModel({
      cfg: {},
      agentDir: "/tmp/quantumclaw-agent",
      provider: "minimax-portal",
      model: "MiniMax-VL-01",
    ...
    expect(ensureQuantumClawModelsJsonMock).toHaveBeenCalled();
