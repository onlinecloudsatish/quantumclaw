...
import type { QuantumClawPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: QuantumClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<QuantumClawPluginApi, "config">;
