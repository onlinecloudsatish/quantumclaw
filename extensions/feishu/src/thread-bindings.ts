...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "quantumclaw/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("quantumclaw.feishuThreadBindingsState");
