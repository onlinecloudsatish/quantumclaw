...
export function applyXiaomiProviderConfig(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyXiaomiConfig(cfg: QuantumClawConfig): QuantumClawConfig {
