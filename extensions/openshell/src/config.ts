...
import type { QuantumClawPluginConfigSchema } from "quantumclaw/plugin-sdk/core";
...
const DEFAULT_SOURCE = "quantumclaw";
...
export function createOpenShellPluginConfigSchema(): QuantumClawPluginConfigSchema {
