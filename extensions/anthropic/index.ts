...
import { parseDurationMs } from "quantumclaw/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { normalizeModelCompat } from "quantumclaw/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "quantumclaw/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("quantumclaw doctor --yes")}"`,
  ].join("\n");
}
