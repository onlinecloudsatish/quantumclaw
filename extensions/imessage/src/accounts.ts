...
function mergeIMessageAccountConfig(cfg: QuantumClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: QuantumClawConfig): ResolvedIMessageAccount[] {
