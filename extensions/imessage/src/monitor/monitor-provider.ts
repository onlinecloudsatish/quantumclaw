...
import { createChannelPairingChallengeIssuer } from "quantumclaw/plugin-sdk/channel-pairing";
...
import { normalizeScpRemoteHost } from "quantumclaw/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "quantumclaw/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "quantumclaw/plugin-sdk/media-runtime";
import { kindFromMime } from "quantumclaw/plugin-sdk/media-runtime";
import {
...
import { danger, logVerbose, shouldLogVerbose, warn } from "quantumclaw/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "quantumclaw/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "quantumclaw/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T quantumclaw@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., quantumclaw@192.168.64.3)
