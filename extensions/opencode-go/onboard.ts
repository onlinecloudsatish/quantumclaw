...
export function applyOpencodeGoProviderConfig(cfg: QuantumClawConfig): QuantumClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: QuantumClawConfig): QuantumClawConfig {
