...
import { OLLAMA_DEFAULT_BASE_URL, resolveOllamaApiBase } from "quantumclaw/plugin-sdk/provider-models";

const PROVIDER_ID = "ollama";
const DEFAULT_API_KEY = "ollama-local";

async function loadProviderSetup() {
  return await import("quantumclaw/plugin-sdk/ollama-setup");
}
