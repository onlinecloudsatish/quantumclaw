# @quantumclaw/zalouser

QuantumClaw extension for Zalo Personal Account messaging via native `zca-js` integration.
...
```bash
quantumclaw channels login --channel zalouser
quantumclaw channels login --channel zalouser --account work
...
- Login not persisted: `quantumclaw channels logout --channel zalouser && quantumclaw channels login --channel zalouser`
- Probe status: `quantumclaw channels status --probe`
