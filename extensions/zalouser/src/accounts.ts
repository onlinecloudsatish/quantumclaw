...
function mergeZalouserAccountConfig(cfg: QuantumClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: QuantumClawConfig; accountId?: string | null }) {
