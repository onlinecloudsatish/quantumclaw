...
import type { SessionBindingRecord } from "quantumclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "quantumclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "quantumclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("quantumclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("quantumclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("quantumclaw/plugin-sdk/config-runtime").QuantumClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
