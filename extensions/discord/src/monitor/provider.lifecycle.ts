...
import { createArmableStallWatchdog } from "quantumclaw/plugin-sdk/channel-lifecycle";
import { createConnectedChannelStatusPatch } from "quantumclaw/plugin-sdk/gateway-runtime";
import { danger } from "quantumclaw/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before QuantumClaw can
