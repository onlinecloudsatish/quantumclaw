...
export type DiscordConfig = NonNullable<QuantumClawConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("quantumclaw/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "quantumclaw-bot",
