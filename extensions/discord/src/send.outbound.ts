...
import type { RetryConfig } from "quantumclaw/plugin-sdk/infra-runtime";
import { resolvePreferredQuantumClawTmpDir } from "quantumclaw/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "quantumclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "quantumclaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "quantumclaw/plugin-sdk/media-runtime";
import type { PollInput } from "quantumclaw/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "quantumclaw/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredQuantumClawTmpDir();
