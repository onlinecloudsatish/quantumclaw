...
import { resolveAgentDir } from "quantumclaw/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "quantumclaw/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "quantumclaw/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "quantumclaw/plugin-sdk/config-runtime";
import { formatErrorMessage } from "quantumclaw/plugin-sdk/infra-runtime";
import { resolvePreferredQuantumClawTmpDir } from "quantumclaw/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "quantumclaw/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "quantumclaw/plugin-sdk/speech";
import { textToSpeech } from "quantumclaw/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: QuantumClawConfig; override?: TtsConfig }): {
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredQuantumClawTmpDir(), "discord-voice-"));
