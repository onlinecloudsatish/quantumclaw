...
import { resolveAccountEntry } from "quantumclaw/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, QuantumClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: QuantumClawConfig): ResolvedDiscordAccount[] {
