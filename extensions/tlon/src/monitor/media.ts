...
import { fetchWithSsrFGuard } from "quantumclaw/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to QuantumClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".quantumclaw", "workspace", "media", "inbound");
 ...
 * Format matches QuantumClaw's expected attachment structure.
 */
