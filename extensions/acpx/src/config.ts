...
import type { QuantumClawPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "quantumclaw.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): QuantumClawPluginConfigSchema {
  return {
