...
function mergeSignalAccountConfig(cfg: QuantumClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: QuantumClawConfig): ResolvedSignalAccount[] {
