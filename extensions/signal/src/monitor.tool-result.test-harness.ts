...
vi.mock("quantumclaw/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/quantumclaw-sessions.json"),
...
vi.mock("quantumclaw/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("quantumclaw/plugin-sdk/conversation-runtime")>(
    "quantumclaw/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("quantumclaw/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("quantumclaw/plugin-sdk/security-runtime")>(
    "quantumclaw/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("quantumclaw/plugin-sdk/reply-runtime"),
      import("quantumclaw/plugin-sdk/infra-runtime"),
    ]);
    resetInboundDedupe();
    config = {
