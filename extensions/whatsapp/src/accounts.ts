...
export function listWhatsAppAuthDirs(cfg: QuantumClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: QuantumClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: QuantumClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: QuantumClawConfig): ResolvedWhatsAppAccount[] {
