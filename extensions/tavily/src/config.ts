...
export function resolveTavilySearchConfig(cfg?: QuantumClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: QuantumClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: QuantumClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
