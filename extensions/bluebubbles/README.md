...
This directory contains the **BlueBubbles external channel plugin** for QuantumClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `quantumclaw/plugin-sdk` helpers.
