...
import { resolveChannelMediaMaxBytes, type QuantumClawConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: QuantumClawConfig; accountId?: string }): string[] {
