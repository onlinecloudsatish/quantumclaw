...
} from "quantumclaw/plugin-sdk/account-id";
...
function resolveConfiguredDefaultNostrAccountId(cfg: QuantumClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: QuantumClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: QuantumClawConfig): string {
