...
Nostr DM channel plugin for QuantumClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to QuantumClaw. It enables your bot to:
...
# Configure quantumclaw to use local relay
