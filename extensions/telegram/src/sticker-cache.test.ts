...
vi.mock("quantumclaw/plugin-sdk/agent-runtime", () => ({
...
vi.mock("quantumclaw/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/quantumclaw-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.QUANTUMCLAW_STATE_DIR = "/tmp/quantumclaw-test-sticker-cache";
    fs.rmSync("/tmp/quantumclaw-test-sticker-cache", { recursive: true, force: true });
