...
function createCfg(): QuantumClawConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: QuantumClawConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: QuantumClawConfig, accountId: string) {
...
function startTelegramAccount(cfg: QuantumClawConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: QuantumClawConfig) {
