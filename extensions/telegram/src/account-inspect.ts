import { resolveAccountWithDefaultFallback } from "quantumclaw/plugin-sdk/account-resolution";
import type { QuantumClawConfig } from "quantumclaw/plugin-sdk/config-runtime";
import { coerceSecretRef } from "quantumclaw/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "quantumclaw/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "quantumclaw/plugin-sdk/provider-auth";
...
function inspectTokenValue(params: { cfg: QuantumClawConfig; value: unknown }): {
  token: string;
