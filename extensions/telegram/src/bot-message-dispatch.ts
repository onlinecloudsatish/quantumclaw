...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "quantumclaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: QuantumClawConfig, agentId: string) {
  try {
