...
import type { TelegramNetworkConfig } from "quantumclaw/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "quantumclaw/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "quantumclaw/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "QUANTUMCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "QUANTUMCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "QUANTUMCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable QUANTUMCLAW_TELEGRAM_DNS_RESULT_ORDER
