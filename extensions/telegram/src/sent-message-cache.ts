import { createScopedExpiringIdCache, resolveGlobalMap } from "quantumclaw/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("quantumclaw.telegramSentMessages");
