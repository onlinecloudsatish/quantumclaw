...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): QuantumClawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: QuantumClawConfig): TelegramAccountConfig => {
    try {
