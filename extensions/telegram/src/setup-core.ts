...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "quantumclaw/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://quantumclaw.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("quantumclaw logs --follow")}\` (safest)`,
