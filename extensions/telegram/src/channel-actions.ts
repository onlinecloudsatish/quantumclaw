...
} from "quantumclaw/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "quantumclaw/plugin-sdk/config-runtime";
import { extractToolSend } from "quantumclaw/plugin-sdk/tool-send";
import {
