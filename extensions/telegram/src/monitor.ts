...
import { resolveAgentMaxConcurrent } from "quantumclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "quantumclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: QuantumClawConfig): RunOptions<unknown> {
  return {
    sink: {
