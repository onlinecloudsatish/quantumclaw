...
import type { GetReplyOptions, MsgContext } from "quantumclaw/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("quantumclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as QuantumClawConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("quantumclaw/plugin-sdk/media-runtime")>,
) {
...
vi.mock("quantumclaw/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("quantumclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
