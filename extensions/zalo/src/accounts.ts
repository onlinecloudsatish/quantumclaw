...
function mergeZaloAccountConfig(cfg: QuantumClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: QuantumClawConfig): ResolvedZaloAccount[] {
