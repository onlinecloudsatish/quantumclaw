import type { ChannelSetupInput } from "quantumclaw/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "quantumclaw/plugin-sdk/secret-input";
import { setSetupChannelEnabled } from "quantumclaw/plugin-sdk/setup";
import { type ChannelSetupWizard } from "quantumclaw/plugin-sdk/setup";
import { formatDocsLink } from "quantumclaw/plugin-sdk/setup";
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "QuantumClaw" "<shared-secret>" "<webhook-url>" --feature reaction',
