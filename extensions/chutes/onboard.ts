 ...
 */
export function applyChutesProviderConfig(cfg: QuantumClawConfig): QuantumClawConfig {
 ...
 */
export function applyChutesConfig(cfg: QuantumClawConfig): QuantumClawConfig {
...
export function applyChutesApiKeyConfig(cfg: QuantumClawConfig): QuantumClawConfig {
