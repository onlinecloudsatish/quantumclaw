...
import type { QuantumClawConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
async function runLogoutScenario(params: { cfg: QuantumClawConfig; accountId: string }): Promise<{
