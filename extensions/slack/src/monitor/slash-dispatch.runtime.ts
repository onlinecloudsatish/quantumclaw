import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "quantumclaw/plugin-sdk/config-runtime";
import {
...
} from "quantumclaw/plugin-sdk/reply-runtime";
import { resolveAgentRoute as resolveAgentRouteImpl } from "quantumclaw/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("quantumclaw/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("quantumclaw/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("quantumclaw/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("quantumclaw/plugin-sdk/conversation-runtime").resolveConversationLabel;
...
type ResolveMarkdownTableMode =
  typeof import("quantumclaw/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("quantumclaw/plugin-sdk/routing").resolveAgentRoute;
