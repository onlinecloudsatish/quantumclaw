...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): QuantumClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: QuantumClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: QuantumClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
