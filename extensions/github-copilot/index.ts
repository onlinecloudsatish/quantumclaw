import { ensureAuthProfileStore, listProfilesForProvider } from "quantumclaw/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "quantumclaw/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "quantumclaw/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "quantumclaw/plugin-sdk/provider-auth-login";
