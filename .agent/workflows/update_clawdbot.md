---
description: Update QuantumClaw from upstream when branch has diverged (ahead/behind)
---

# QuantumClaw Upstream Sync Workflow
...
```bash
# Kill running app
pkill -x "QuantumClaw" || true

# Move old version
mv /Applications/QuantumClaw.app /tmp/QuantumClaw-backup.app

# Install new build
cp -R dist/QuantumClaw.app /Applications/

# Launch
open /Applications/QuantumClaw.app
```
...
# Update quantumclaw.json with fallback chains
