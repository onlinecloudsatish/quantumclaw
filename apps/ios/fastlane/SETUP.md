# fastlane setup (QuantumClaw iOS)
...
ASC_KEYCHAIN_SERVICE=quantumclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.quantumclaw.client
# or
...
- The beta flow regenerates `apps/ios/QuantumClaw.xcodeproj` from `apps/ios/project.yml` before archiving
