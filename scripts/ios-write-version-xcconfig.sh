...
- QUANTUMCLAW_GATEWAY_VERSION = exact package.json version
- QUANTUMCLAW_MARKETING_VERSION = short iOS/App Store version
- QUANTUMCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
QUANTUMCLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
QUANTUMCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
QUANTUMCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
