...
if [[ -z "$version_content" ]]; then
  echo "<h2>QuantumClaw $VERSION</h2>"
  echo "<p>Latest QuantumClaw update.</p>"
  echo "<p><a href=\"https://github.com/quantumclaw/quantumclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
