...
show_usage() {
    cat << EOF
clawlog - QuantumClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View QuantumClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    QuantumClaw logs flow through the macOS unified log (subsystem: ai.quantumclaw).
