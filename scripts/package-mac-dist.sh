...
#
# Output:
# - dist/QuantumClaw.app
# - dist/QuantumClaw-<version>.zip
# - dist/QuantumClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.quantumclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/QuantumClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/QuantumClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/QuantumClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/QuantumClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/QuantumClaw-$VERSION.dSYM.zip"
