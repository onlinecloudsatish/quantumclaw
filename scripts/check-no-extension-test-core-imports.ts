...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']quantumclaw\/plugin-sdk["']/,
    hint: "Use quantumclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']quantumclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use quantumclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']quantumclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or quantumclaw/plugin-sdk/testing for public surfaces.",
  },
  {
